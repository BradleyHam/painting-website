...
import { faPhone, faEnvelope, faLongArrowAltRight, faCheck, faMapMarkerAlt } from '@fortawesome/free-solid-svg-icons'
...
export default GoogleApiWrapper({
    // apiKey: ('AIzaSyCpOr_UCSxhumuxXi8Pg_oDCjSpEmuHf6w')
})(ContactComponent)